...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /media/yuhuang/PSSD/gglearn/db_motion_planning/Motion-Planning-for-Mobile-Robots-main/workspace/assignments/01-env-setup/ROS/src/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /media/yuhuang/PSSD/gglearn/db_motion_planning/Motion-Planning-for-Mobile-Robots-main/workspace/assignments/01-env-setup/ROS/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /media/yuhuang/PSSD/gglearn/db_motion_planning/Motion-Planning-for-Mobile-Robots-main/workspace/assignments/01-env-setup/ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/yuhuang/PSSD/gglearn/db_motion_planning/Motion-Planning-for-Mobile-Robots-main/workspace/assignments/01-env-setup/ROS/src/rviz_plugins/${idir}'.  ${_report}")
    endif()
