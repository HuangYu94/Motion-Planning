...
: ${_CATKIN_SETUP_DIR:=/media/yuhuang/PSSD/gglearn/db_motion_planning/Motion-Planning-for-Mobile-Robots-main/workspace/assignments/01-env-setup/ROS/src/grid_path_searcher/cmake-build-debug/devel}
